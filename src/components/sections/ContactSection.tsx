...
export default function ContactSection() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validate()) {
            ...
            const text = `*New Project Inquiry from Portfolio*%0A%0A*Name:* ${formData.name}%0A*Business Type:* ${formData.businessType}%0A*Project Type:* ${formData.projectType}%0A*Budget:* ${formData.budget || 'Not specified'}%0A*Message:* ${formData.message}`;
            const whatsappUrl = `https://wa.me/917865055431?text=${text}`;
