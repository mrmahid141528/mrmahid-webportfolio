...
const StatCounter = ({ value, label, suffix = "", icon: Icon }: any) => {
    ...
    return (
        <div ref={ref} className="flex flex-col items-center justify-center p-8 rounded-3xl glass-panel border border-white/5 bg-card backdrop-blur-sm group hover:border-primary/20 transition-colors cursor-hover">
            ...
            <div className="text-muted font-medium tracking-wide">{label}</div>
        </div>
    );
};
...
export default function StatsSection() {
    ...
    return (
        <section className="relative py-24 bg-alt z-10 overflow-hidden border-y border-white/5">
            {/* Background elements */}
