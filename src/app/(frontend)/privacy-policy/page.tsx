    ...
    return (
        <main className="flex flex-col min-h-screen pt-32 pb-24 bg-[#0F172A] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10 prose prose-invert prose-lg prose-a:text-primary hover:prose-a:text-accent">
                ...
                <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Log Files</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Cookies and Web Beacons</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Google DoubleClick DART Cookie</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Third Party Privacy Policies</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Consent</h2>
                <p>
