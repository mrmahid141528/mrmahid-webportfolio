    ...
    return (
        <main className="flex flex-col min-h-screen pt-32 pb-24 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10 prose prose-invert prose-lg prose-a:text-primary hover:prose-a:text-accent">
                ...
                <h2 className="text-2xl font-semibold text-foreground mt-10 mb-4">General Information</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-foreground mt-10 mb-4">External Links Disclaimer</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-foreground mt-10 mb-4">Professional Disclaimer</h2>
                <p>
